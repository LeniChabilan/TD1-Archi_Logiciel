$(function() {
    ...
    function refreshTaskList(){
        $("#currenttask").empty();
        requete = "http://localhost:3000/todo/api/v1.0/tasks";
        fetch(requete)
        .then( response => {
    ...
    function fillFormTask(t){
        ...
        $("#currenttask #descr").val(t.description);
         t.uri=(t.uri == undefined)?"http://localhost:3000/todo/api/v1.0/tasks"+t.id:t.uri;
    ...
    function saveNewTask(){
        ...
        fetch("http://localhost:3000/todo/api/v1.0/tasks",{
        headers: {
